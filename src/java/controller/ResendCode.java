...
public class ResendCode extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //send email
        String subject = "Mã xác minh mới";
        String message = "Mã xác minh mới của bạn là: " + verificationCode;

        if (EmailUtil.sendEmail(email, subject, message)) {
            request.setAttribute("success", "Mã xác minh mới đã được gửi.");
        } else {
            request.setAttribute("error", "Không thể gửi lại mã xác minh.");
        }
