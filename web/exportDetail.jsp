<%-- 
    ...
    Created on : Aug 1, 2025, 6:11:38 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Export Bill Details</title>
        ...
        <div class="d-flex">
            ...
            <div class="main-content">
                <div class="detail-container">
                    <h1>Export Bill #${exportBill.exportId}</h1>

                    <div class="bill-info">
                        <p><strong>Shop:</strong> ${exportBill.shop.shopName} (${exportBill.shop.location})</p>
                        <p><strong>Export Date:</strong> <fmt:formatDate value="${exportBill.exportDate}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
                        <p><strong>Status:</strong> ${exportBill.status}</p>
                        <p><strong>Created By:</strong> User #${exportBill.createdBy}</p>
                    </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <c:forEach items="${exportBill.items}" var="item">
                                <tr>
                        ...
                        <tfoot>
                            <tr class="total-row">
                                ...
                                <td><fmt:formatNumber value="${exportBill.totalAmount}" type="currency" currencySymbol="$"/></td>
                            </tr>
                        </tfoot>
                    </table>

                    <a href="${pageContext.request.contextPath}/export/list" class="btn btn-back">Back to List</a>
                </div>
            </div>
        </div>
    </body>
